...
![Citations](https://img.shields.io/badge/Citations-600+-blue) ![h-index](https://img.shields.io/badge/h--index-9-green) ![A* Conferences](https://img.shields.io/badge/A*-Conferences-orange) ![Q1 Journals](https://img.shields.io/badge/Q1-Journals-10-red) ![Expertise](https://img.shields.io/badge/Expert-ML%20%2F%20DL-purple)
...
### Awards
- **QUT Sage HDR Student Publication Prize**, Queensland University of Technology (QUT), 2025  
- **MBSTU Academic Genius Award**, Mawlana Bhashani Science and Technology University (MBSTU), 2023  
- **Best Trainer**, Ethical Hacking and Cybersecurity in Power Sector, Bangladesh Power Development Board (BPDB), 2022  
- **Best Coach**, Cefalo CodeFiesta 2022: AUST Inter-University Programming Contest, 2022  
- **Top 5 Trainee among 50 IT Engineers**, BHTPA and ICT Division, Bangladesh, 2019  
- **Best Innovative Idea**, Project Show at Digital Innovation Fairs, 2018  
- **Inter-University Programming Contest Winner**, 1st MBSTU CSE Carnival, 2017  

### Scholarships
- **QUTPRA & QUT HDR Tuition Fee Sponsorship**, Full-funded PhD Scholarship, Queensland University of Technology, 2024  
- **MBSTU Faculty of Engineering Scholarship**, B.Sc. (Engg.) and M.Sc. (Engg.), 2015–2019  

### Fellowships
- **ICT Fellowship**, ICT Division, Government of the People’s Republic of Bangladesh, 2020  

### Certificates & Recognition
- **Coach**, ICPC Asia Dhaka Regional Contest, BUBT, 2023  
- **Coach**, BUET Inter-University Programming Contest (IUPC), BUET CSE Fest, 2022  
- **Coach**, ICPC Asia Dhaka Regional Contest, GUB, 2022  
- **EEE Day Inter-University Project/Thesis Presentation**, BUET, 2018  
- **AB Bank – IUT 8th ICT Fest Programming Contest**, 2016  
...
### Journals
1. **S. T. Mehedi**, C. Islam, G. Ramachandran, R. Jurdak,  
   *“DySec: A Machine Learning-based Dynamic Analysis for Detecting Malicious Packages in PyPI Ecosystem,”*  
   IEEE Transactions on Information Forensics and Security, vol. 21, pp. 1316–1331, 2026.

2. **S. T. Mehedi**, L. F. Abdulrazak, K. Ahmed, M. S. Uddin, F. M. Bui, L. Chen, M. A. Moni, F. A. Al-Zahrani,  
   *“A Privacy-Preserving Dependable Deep Federated Learning Model for Identifying New Infections,”*  
   Scientific Reports (Nature), vol. 15, p. 7291, 2025.

3. A. Datta, M. M. Hasan, N. Mahmud, B. J. Ferdosi, R. Islam, Z. Rahman, **S. T. Mehedi**,  
   *“Preserving Medical Information from a Doctor’s Prescription Ensures a Well-Organized Medical History,”*  
   Computers in Biology and Medicine, vol. 188, p. 109812, 2025.

4. J. Tanvir, **S. T. Mehedi**, B. K. Paul, M. Morshed,  
   *“TrashNeXt: Classification of Recyclable Water Pollutants Using Deep Transfer Learning Method,”*  
   Case Studies in Chemical and Environmental Engineering, vol. 11, p. 101073, 2024.

5. S. A. Mahmud, N. Islam, Z. Islam, Z. Rahman, **S. T. Mehedi**,  
   *“Privacy-Preserving Federated Learning-Based IDS for Cyber-Physical Systems,”*  
   Sensors, vol. 20, 2024.

6. M. W. Hasan, S. Shanto, J. Nayeema, R. Rahman, T. Helaly, Z. Rahman, **S. T. Mehedi**,  
   *“An Explainable AI-Based Modified YOLOv8 Model for Efficient Fire Detection,”*  
   Mathematics, vol. 12, no. 19, p. 3042, 2024.

7. S. Gupta, M. R. I. Bhuiyan, S. S. Chowa, S. Montaha, R. Rahman, **S. T. Mehedi**, Z. Rahman,  
   *“Enhancing Autism Spectrum Disorder Classification with Lightweight Quantized CNNs and Federated Learning on ABIDE-1,”*  
   Mathematics, vol. 12, no. 18, p. 2886, 2024.

8. **S. T. Mehedi**, A. Anwar, Z. Rahman et al.,  
   *“Dependable Intrusion Detection System for IoT: A Deep Transfer Learning-Based Approach,”*  
   IEEE Transactions on Industrial Informatics, vol. 19, no. 1, pp. 1006–1017, 2022.

9. Z. Rahman, X. Yi, **S. T. Mehedi** et al.,  
   *“Blockchain Applicability for IoTs: Performance and Scalability Challenges and Solutions,”*  
   Electronics, vol. 11, no. 2, 2022.

10. **S. T. Mehedi**, K. Ahmed, F. M. Bui et al.,  
    *“MLBioIGE: Integration of Machine Learning and Bioinformatics to Identify the Genetic Effect of SARS-CoV-2 on Idiopathic Pulmonary Fibrosis Patients,”*  
    Biology Methods and Protocols, vol. 7, no. 1, 2022.

11. M. Billah, **S. T. Mehedi**, A. Anwar et al.,  
    *“A Systematic Literature Review on Blockchain-Enabled Federated Learning Framework for IoVs,”*  
    IEEE Access, 2022.

12. **S. T. Mehedi**, A. Anwar, Z. Rahman et al.,  
    *“Deep Transfer Learning-Based Intrusion Detection System for Electric Vehicular Networks,”*  
    Sensors, vol. 21, no. 14, 2021.

13. **S. T. Mehedi**, A. A. M. Shamim K. Ahmed et al.,  
    *“Graphene Injected D-Shape Photonic Crystal Fiber for Nonlinear Optical Applications,”*  
    Silicon, vol. 12, pp. 2293–2300, 2020.

14. **S. T. Mehedi**, A. A. M. Shamim, M. B. A. Miah,  
    *“Blockchain-Based Security Management of IoT Infrastructure with Ethereum Transactions,”*  
    IJCS, vol. 2, pp. 189–195, 2019.

---

### Conferences
1. **S. T. Mehedi**, R. Jurdak, C. Islam, G. Ramachandran,  
   *“QUT-DV25: A Dataset for Dynamic Analysis of Next-Gen Software Supply Chain Attacks,”*  
   NeurIPS 2025 (Datasets and Benchmarks), San Diego, USA, 2025.

2. M. R. I. Evan, M. M. Rahman, **S. T. Mehedi**, A. Nazib, R. Islam, Z. Rahman,  
...
3. J. Ferdows, **S. T. Mehedi**, A. S. M. Hossain et al.,  
   *“A Comprehensive Study of IoT Application Layer Security Management,”*  
   IEEE INOCON, 2020.

---

### Book Chapters
1. A. A. Sefat, G. M. R. I. Rasiq, **S. T. Mehedi**,  
   *“CPU Performance Prediction Using Various Regression Algorithms,”*  
   Algorithms for Intelligent Systems, Springer, 2021.
